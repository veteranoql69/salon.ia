...
export default function AgendaDashboardPage() {
  ...
  // Barber ID ficticio, vendría de session/auth
  ...
  const handleBlockTime = async () => {
    ...
    // Parse selected time string back into the date object
    ...
    const result = await createAppointment({
      barber_id: barberId,
      customer_id: null, // Null is allowed when status is 'blocked'
  ...
  // Generar opciones de hora para el dropdown
